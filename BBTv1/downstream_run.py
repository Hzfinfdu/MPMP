...
parser.add_argument("--step_size1", default=500 * 2, type=int)
parser.add_argument("--step_size2", default=500 * 2, type=int)
...
save_path = f'/home/ma-user/work/zfhe/PrefixPretraining/results/PromptTokens50_BatchSize32_NPrompts8_LrRouter0.005_LrPrompt0.001_AnnealParams1.0;None;None_downstream'
...
state = torch.load('/home/ma-user/work/zfhe/BBTPromptPretraining/results/PromptTokens50_BatchSize32_NPrompts8_LrRouter0.005_LrPrompt0.001_AnnealParams1.0;None;0.1/models/1650000.th')
...
if args.step_size1 is not None and args.step_size2 is not None and args.gamma1 is not None and args.gamma2 is not None:
    ...
    scheduler = None
args.save_path = f'/home/ma-user/work/zfhe/BBTPromptPretraining/downstream_results/PromptTokens50_BatchSize32_NPrompts8_LrRouter0.005_LrPrompt0.001_AnnealParams1.0;None;None_downstream'
