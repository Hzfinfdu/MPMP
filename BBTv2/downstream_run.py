...
parser.add_argument("--gamma2", default=2e14, type=float)
parser.add_argument("--task_name", default='iflytek', type=str)
...
state = torch.load('/home/ma-user/work/zfhe/MPMP/BBTv2/results/PromptTokens50_BatchSize32_NPrompts8_LrRouter0.0005_LrPrompt0.0001_AnnealParams1.0NoneNone/best.th')
