...
class AFQMC(datasets.GeneratorBasedBuilder):
    def _info(self):
    ...
    def _split_generators(self, dl_manager):
        files_to_download = {
            'train': '/remote-home/share/ChineseData/chineseeval/AFQMC/train.json',
            'dev': '/remote-home/share/ChineseData/chineseeval/AFQMC/dev.json',
        }
